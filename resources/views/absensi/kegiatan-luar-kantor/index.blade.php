                    ...
                    <div class="card-body">
                        <div class="form-group mb-3">
                            ...
                            <select name="absensi" id="filter_absensi" class="form-select" onchange="getValueSelectFilter()">
                                ...
                                <option name="keluar" value="keluar">Keluar</option>
                ...
                <div class="card shadow-lg card__one animate__animated  animate__fadeInUp card-2">
                    ...
                    <div class="card-body">
                        ...
                        <div class="punch-det">
                            <div class="row">
                                <div class="col-6">
                                    <h6 class="mb-1 mt-1 fw-bold">Jam Keluar: </h6>
                                    <span class="mt-0" id="waktu_keluar">-</span>
                                </div>
                                <div class="col-6">
    ...
    <script>
            ...
            alertify.confirm("APAKAH ANDA YAKIN ?", function () {
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        'type_absensi' : 'Kegiatan Luar Kantor'
                    },
                    success: function(data) {
                        ...
                        }else if(data.data.jenis_absensi == 'keluar'){
                            Swal.fire({
                                title: 'Success !',
                                icon: 'success',
        ...
        function getDataAbsen(userId) {
            $.ajax({
                type: 'POST',
                dataType: 'json',
                url: '/api/get-absensi/kegiatan-luar-kantor',
                data: {
                    'user_id': userId,
                },
                success: function(data) {
                    if (data.data.jenis_absensi == 'keluar') {
                        $("select  option[value='keluar']").attr('disabled', 'disabled');
                        $("select  option[value='keluar']").text('Keluar (Disabled)');
                        ...
                        // WAKTU ABSEN
                        $('#waktu_keluar').text(moment(data.data.timestamp).format('HH : mm : ss'));
                    ...
                    } else if(data.data.jenis_absensi == 'masuk') {
                        ...
                        if (data.waktu_keluar == '-') {
                            ...
                            $('#waktu_keluar').text(moment(data.waktu_keluar).format('HH : mm : ss'));
                        }
        ...
        function getValueSelectFilter(){
            ...
            if (val == 'masuk') {
                ...
                $('#button-absensi').text('ABSENSI KELUAR')
