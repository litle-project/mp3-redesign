                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input  class="form-control @error('judul') is-invalid @enderror"  type="text" name="judul" id="judul"  value="{{$berita->judul}}">
                                ...
                                <img src="{{asset($berita->gambar)}}"   height="160px" class="image img"/>
                                <div class="form-group mb-3">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea name="isi" class="form-control" id="" cols="30" rows="3">{{$berita->isi}}</textarea>
                                    @error('isi')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
