        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('master-data.koordinat-kantor.store') }}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-lg-4">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group mb-3">
                                    ...
                                    <div class="input-group">
                                        <input  class="form-control @error('radius') is-invalid @enderror"  type="number" name="radius" id="radius" placeholder="input radius" value="{{old('radius')}}">
