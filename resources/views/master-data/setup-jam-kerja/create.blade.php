...
<div class="page-content">
    <div class="row animate__animated  animate__fadeIn">
        <div class="col-lg-6">
            <form method="POST" action="{{ route('master-data.setup-jam-kerja.store') }}">
                @csrf
                                ...
                                <div class="row">
                                    <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="time" name="jam_keluar_istirahat" class="form-control @error('jam_keluar_istirahat') is-invalid @enderror" placeholder="">
                                    ...
                                    <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="time" name="jam_masuk_istirahat" class="form-control @error('jam_masuk_istirahat') is-invalid @enderror" placeholder="">
