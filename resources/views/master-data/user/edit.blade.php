...
<div class="page-content">
    ...
    <div class="row animate__animated  animate__fadeIn">
        <div class="col-lg-12">
            <div class="card" style="border-radius:15px;">
                <div class="card-header text-center" style="border-radius:15px 15px 0px 0px;">
    ...
    <div class="row animate__animated  animate__fadeIn">
        <div class="col-lg-12">
            <form action="{{ route('master-data.user.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                @method('patch')
                @csrf
